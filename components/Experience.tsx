...
export default function Experience(){
  ...
  return <section id="experience" className="page-section process" ref={root}>
    ...
    <style jsx global>{`
      ...
      @media(max-width:760px){.process{min-height:auto!important;padding-bottom:76px!important}.process__intro h2{font-size:clamp(46px,13vw,72px);white-space:normal}.process__intro p br{display:none}.career-flow{display:grid;grid-template-columns:minmax(0,1fr);min-height:0;padding-left:31px;gap:16px}.career-flow:before{position:absolute;top:13px;bottom:13px;left:12px;width:1px;background:linear-gradient(180deg,rgba(255,35,45,.75),rgba(255,35,45,.18) 72%,rgba(255,255,255,.08));content:""}.career-path--desktop,.career-path--mobile{display:none}.career-milestone{position:relative;left:auto;right:auto;top:auto;width:100%;max-width:none;min-height:0;margin:0;padding:20px}.career-milestone--1,.career-milestone--2,.career-milestone--3{left:auto;right:auto;top:auto;grid-column:auto;margin:0;justify-self:stretch}.career-milestone:before{position:absolute;top:24px;left:-24px;width:9px;height:9px;border:2px solid var(--bg-secondary);border-radius:50%;background:var(--accent);box-shadow:0 0 0 3px rgba(255,35,45,.15);content:""}.career-milestone h3{font-size:clamp(30px,9vw,39px)}.process__credentials{position:relative;z-index:2;grid-template-columns:1fr;margin-top:22px}}
